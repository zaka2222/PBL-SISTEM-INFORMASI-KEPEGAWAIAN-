                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 font-weight-bold"><label style="color: blue">LOGIN ADMIN</h1></label>
                                    ...
                                    <form class="user" method="POST" action="cek_login.php">
                                        ...
                                        <label class="col-sm-1 col-form-label"><i class="fas fa-fw fa-user"></i></label>
                                            <div class="col-sm-11">
                                            <input class="form-control form-control-user" name="username" placeholder="Username" type="username" required oninvalid="this.setCustomValidity('Data Harap diisi !')" oninput="setCustomValidity('')">
                                            </div>
                                        </div>
                                        <div class="form-group row">
