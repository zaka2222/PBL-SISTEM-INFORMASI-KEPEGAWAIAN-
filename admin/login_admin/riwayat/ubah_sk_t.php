...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_sk_t.php?nip_nup=<?php echo $data['nip_nup']; ?>&&id_sk=<?php echo $data['id_sk']; ?>" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/sk_tetap.php?nip_nup=<?php echo $data['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
