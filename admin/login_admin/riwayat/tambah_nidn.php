...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-12">
                       <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Dashboard / Tambah Data NIDN</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
        ...
        <form method="POST" action="aksi_tambah_nidn.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" enctype="multipart/form-data">
...
<!--
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">File NIDN</label>
                <div class="col-sm-9">
                    <input class="input-group" type="file" name="file_nidn" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
...
-->
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/nidn.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>
