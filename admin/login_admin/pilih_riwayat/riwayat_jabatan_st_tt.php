...
<body id="page-top">
  ...
  <div class="card-body">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <b> Silahkan Pilih : &nbsp;Jabatan Struktural/Tugas Tambahan</b>  </a>
                <div class="dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="../riwayat.php?nip_nup=<?php echo $_GET['nip_nup']; ?>"> Penyesuaian Ijazah</a>
                    <a class="dropdown-item" href="sk_capeg_tetap.php?nip_nup=<?php echo $_GET['nip_nup']; ?>"> Capeg/Tetap</a>
                    <a class="dropdown-item" href="sk_penyesuaian_masa.php?nip_nup=<?php echo $_GET['nip_nup']; ?>"> Penyesuaian Masa</a>
    ...
    <center><label><b> Jabatan Struktural/Tugas Tambahan </b></label></center><br>
    <div class="table-responsive">
        <a href="../riwayat/tambah_riwayat_st.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                ...
                $data_riwayat_st = mysqli_query($koneksi,"select * from riwayat_jabatan_struktural where nip_nup='$_GET[nip_nup]'");
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        <a class="btn btn-warning btn-sm" href="../riwayat/ubah_riwayat_st.php?id_riwayat_jabatan_s=<?php echo $data['id_riwayat_jabatan_s']; ?>" title="Ubah"><i class="fas fa-edit"></i></a>

                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_riwayat_st.php?id_riwayat_jabatan_s=<?php echo $data['id_riwayat_jabatan_s']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
