                    ...
                    <form class="form-horizontal" action="../simpan.php" method="post">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown"><p>
                                <div><center>
                                    <label style="color: blue">Pegawai Sudah Ganti Password</label></center>
                                </div>
                                <hr>
                                ...
                                ?>
                                    ...
                                    <a href="data_pegawai.php" class="clearfix">
                                         <a class="dropdown-item">
                                            <i class="fas fa-sign-in-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                                <span class="title"><?php echo $datadb['nama_pegawai']; ?></span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Sistem Informasi Pegawai</h5>
