...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <center><label><b> Tetap</b></label></center><br>
    <div class="table-responsive">
        <a href="../riwayat/tambah_sk_t.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                $no = 0;
                $data_sk = mysqli_query($koneksi,"select * from data_sk where nip_nup='$_GET[nip_nup]' and jenis_sk='SK Tetap'");
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-warning btn-sm" href="../riwayat/ubah_sk_t.php?id_sk=<?php echo $data['id_sk']; ?>" title="Ubah"><i class="fas fa-edit"></i></a>

                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_sk_t.php?id_sk=<?php echo $data['id_sk']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
