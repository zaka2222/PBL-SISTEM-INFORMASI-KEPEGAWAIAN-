...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                              $pegawai=$koneksi->query("SELECT * FROM data_pegawai WHERE nip_nup='$_GET[nip_nup]'");
 ...
 <form method="POST" action="aksi_ubah_p.php" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="nip" class="col-sm-3 col-form-label">NIP/NUP</label>
                <div class="col-sm-9">

                    <input type="text" name="nip_nup" class="form-control" placeholder="nip_nup  *" value= "<?php echo $data['nip_nup'];?>" title="NIP/NUP " readonly>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="password" class="form-control" placeholder="password Sesuai KTP  *" value= "<?php echo $data['password'];?>" title="password " required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
