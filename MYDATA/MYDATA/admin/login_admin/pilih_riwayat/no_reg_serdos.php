...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_no_rs.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                $no = 0;
                $data_no_reg_serdos = mysqli_query($koneksi,"select * from no_reg_serdos where nip_nup='$_GET[nip_nup]'");
...
-->
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_no_rs.php?id_no_reg_serdos=<?php echo $data['id_no_reg_serdos']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
