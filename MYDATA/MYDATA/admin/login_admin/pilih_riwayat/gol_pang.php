...
<body id="page-top">
  ...
  <div class="card-body">
    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <b> Silahkan Pilih : &nbsp; Golongan/Pangkat </b> </a>
    ...
    <center><label><b>Golongan/Pangkat </b></label></center><br>
    <div class="table-responsive">
        <a href="../riwayat/tambah_gp.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                ...
                $data_golongan = mysqli_query($koneksi,"select * from golongan where nip_nup='$_GET[nip_nup]'");
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        <a class="btn btn-warning btn-sm" href="../riwayat/ubah_gp.php?id_gol=<?php echo $data['id_gol']; ?>" title="Ubah"><i class="fas fa-edit"></i></a>

                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_gp.php?id_gol=<?php echo $data['id_gol']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
