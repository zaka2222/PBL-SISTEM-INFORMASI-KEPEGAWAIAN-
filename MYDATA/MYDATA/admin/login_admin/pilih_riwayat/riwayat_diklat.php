...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <center><label><b> Diklat </b></label></center><br>
    <div class="table-responsive">
        <a href="../riwayat/tambah_riwayat_d.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                ...
                $data_riwayat_diklat = mysqli_query($koneksi,"select * from riwayat_diklat where nip_nup='$_GET[nip_nup]'");
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        <a class="btn btn-warning btn-sm" href="../riwayat/ubah_riwayat_d.php?id_riwayat_diklat=<?php echo $data['id_riwayat_diklat']; ?>" title="Ubah"><i class="fas fa-edit"></i></a>

                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_riwayat_d.php?id_riwayat_diklat=<?php echo $data['id_riwayat_diklat']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
