...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4 border-bottom-primary">
                                <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a class="nav-link active" data-toggle="tab" href="pendidikan.php?nip_nup=<?php echo $_GET['nip_nup']; ?>"><b>Pendidikan</b></a></li>
  ...
  <div class="card-body">
    <div class="table-responsive">
        <a href="pendidikan/tambah_pendidikan.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-danger btn-sm" href="pendidikan/aksi_hapus_pen.php?id_pendidikan=<?php echo $data['id_pendidikan']; ?>&nip_nup=<?php echo $_GET['nip_nup']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
