            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-12">
                       <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Dashboard / Detail Data Pendidikan</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <a href="view.php?file_ijazah=<?php echo $data['file_ijazah']; ?>">
                                     ...
                                     <?php elseif ($cek2>=1): ?>
                                        ...
                                        <a href="#muncul<?php echo $data['id_pendidikan']; ?>" data-toggle="modal">
                                          <img src="../../../login_pegawai/pendidikan/file_ijazah/<?php echo $data['file_ijazah']; ?>" class="img-fluid shadow" style="width: 500px;"></p>
                                        </a>
