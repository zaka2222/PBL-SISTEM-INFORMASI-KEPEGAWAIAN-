...
$koneksi->query("INSERT INTO riwayat_pendidikan(no_ijazah,nip_nup,tgl_lulus,nama_universitas,tingkat_pendidikan,file_ijazah) VALUES
	('$no_ijazah','$nip_nup','$tgl_lulus','$nama_universitas','$tingkat_pendidikan','$namabaru')");
