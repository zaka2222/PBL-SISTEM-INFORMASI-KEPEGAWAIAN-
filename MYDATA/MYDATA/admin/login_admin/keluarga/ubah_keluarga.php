...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_kel.php?nip_nup=<?php echo $data['nip_nup']; ?>&&id_keluarga=<?php echo $data['id_keluarga']; ?>" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="../keluarga.php?nip_nup=<?php echo $data['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
