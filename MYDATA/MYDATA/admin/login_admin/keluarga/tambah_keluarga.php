...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <form method="POST" action="aksi_tambah_kel.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="../keluarga.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>
