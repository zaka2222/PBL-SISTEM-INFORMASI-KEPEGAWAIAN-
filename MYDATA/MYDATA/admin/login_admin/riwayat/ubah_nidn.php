...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_nidn.php?nip_nup=<?php echo $data['nip_nup']; ?>" enctype="multipart/form-data">
...
-->
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/nidn.php?nip_nup=<?php echo $data['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
