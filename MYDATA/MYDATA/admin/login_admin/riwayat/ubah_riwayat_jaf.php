...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_riwayat_jaf.php?nip_nup=<?php echo $data['nip_nup']; ?>" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/riwayat_jabatan_aka_fung.php?nip_nup=<?php echo $data['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
