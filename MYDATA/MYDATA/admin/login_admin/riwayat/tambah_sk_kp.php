...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-12">
                       <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Dashboard / Tambah Data SK Kenaikan Pangkat</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
        ...
        <form method="POST" action="aksi_tambah_sk_kp.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="hidden" name="jenis_sk" class="form-control" value= "SK Kenaikan Pangkat">
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/sk_kenaikan_pangkat.php?nip_nup=<?php echo $_GET['nip_nup']; ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>
