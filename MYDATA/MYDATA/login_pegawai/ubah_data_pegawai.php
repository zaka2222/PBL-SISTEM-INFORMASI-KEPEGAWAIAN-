...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <form method="POST" action="aksi_ubah_pegawai.php" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <input type="hidden" name="notif_profil" class="form-control" value= "Sudah Mengisi Profil">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="status_pegawai" id="status_pegawai">
                        ...
                        <option value="Non-ASN"<?php if($data['status_pegawai'] == 'Non-ASN'){ echo 'selected'; } ?>>Non-ASN</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="number" name="no_bpjs_kesehatan" class="form-control" placeholder="Nomor BPJS Kesehatan  *" value= "<?php echo $data['no_bpjs_kesehatan'];?>" title="Nomor BPJS Kesehatan "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="number" name="no_bpjs_ketenagakerjaan" class="form-control" placeholder="Nomor BPJS Ketenagakerjaan  *" value= "<?php echo $data['no_bpjs_ketenagakerjaan'];?>" title="Nomor BPJS Ketenagakerjaan "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="no_hp" class="col-sm-3 col-form-label">No. SK</label>
                <div class="col-sm-9">
                    <input type="number" name="no_sk_nidn" class="form-control" placeholder="No SK  *" value= "<?php echo $data['no_sk_nidn'];?>" title="No SK "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="form-group row">
                <label for="ttl" class="col-sm-3 col-form-label">TMT</label>
                <div class="col">
                    <input type="date" name="tmt_nidn" class="form-control" placeholder="TMT  *" value= "<?php echo $data['tmt_nidn'];?>" title="TMT "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="form-group row">
                <label for="ttl" class="col-sm-3 col-form-label">Tanggal SK</label>
                <div class="col">
                    <input type="date" name="tgl_sk_nidn" class="form-control" placeholder="Tanggal SK  *" value= "<?php echo $data['tgl_sk_nidn'];?>" title="Tanggal SK "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="no_hp" class="col-sm-3 col-form-label">No. SK</label>
                <div class="col-sm-9">
                    <input type="number" name="no_sk_ntik" class="form-control" placeholder="No SK  *" value= "<?php echo $data['no_sk_ntik'];?>" title="No SK "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="form-group row">
                <label for="ttl" class="col-sm-3 col-form-label">TMT</label>
                <div class="col">
                    <input type="date" name="tmt_ntik" class="form-control" placeholder="TMT  *" value= "<?php echo $data['tmt_ntik'];?>" title="TMT "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="form-group row">
                <label for="ttl" class="col-sm-3 col-form-label">Tanggal SK</label>
                <div class="col">
                    <input type="date" name="tgl_sk_ntik" class="form-control" placeholder="Tanggal SK  *" value= "<?php echo $data['tgl_sk_ntik'];?>" title="Tanggal SK "required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
        ...
        <div class="card-footer">
            ...
            <a href="index.php" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>
