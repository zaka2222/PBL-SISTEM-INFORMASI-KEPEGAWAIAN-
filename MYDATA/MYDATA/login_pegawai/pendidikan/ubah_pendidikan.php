...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_pen.php?id_pendidikan=<?php echo $data['id_pendidikan']; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <label style="color: blue"><?php echo $data['file_ijazah'];?></label><br>
