...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-12">
                       <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Dashboard / Ubah NIDN</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
 ...
 <form method="POST" action="aksi_ubah_nidn.php" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="nip" class="col-sm-3 col-form-label">Nomor</label>
                <div class="col-sm-9">

                    <input type="hidden" name="id_nidn" class="form-control" placeholder="id_nidn  *" value= "<?php echo $data['id_nidn'];?>" title="id_nidn " readonly>
                    <input type="hidden" name="nip_nup" class="form-control" placeholder="nip_nup  *" value= "<?php echo $data['nip_nup'];?>" title="nip_nup " readonly>

                    <input type="hidden" name="nama_pegawai" class="form-control" placeholder="nama_pegawai  *" value= "<?php echo $datalogin['nama_pegawai'];?>" title="nama_pegawai " readonly>
...
<!--
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <?php echo $data['file_nidn'];?><br>
                    <input class="input-group" type="file" name="file_nidn">
...
-->
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/nidn.php" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
