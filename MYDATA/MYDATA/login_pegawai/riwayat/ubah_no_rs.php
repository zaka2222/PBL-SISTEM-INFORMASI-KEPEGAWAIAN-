...
<body id="page-top">
 ...
 <form method="POST" action="aksi_ubah_no_rs.php" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input type="text" name="tempat" class="form-control" placeholder="Penyelenggara  *" value= "<?php echo $data['tempat'];?>" title="Penyelenggara " required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="form-group row">
