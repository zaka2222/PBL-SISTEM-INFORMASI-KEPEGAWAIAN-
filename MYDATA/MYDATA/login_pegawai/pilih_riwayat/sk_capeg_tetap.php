...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_sk_ct.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_sk_ct.php?id_sk=<?php echo $data['id_sk']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
