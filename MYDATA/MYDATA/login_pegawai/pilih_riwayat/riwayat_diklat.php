...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_riwayat_d.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_riwayat_d.php?id_riwayat_diklat=<?php echo $data['id_riwayat_diklat']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
                    <td><?php echo $data['no_sertifikat']; ?></td>
                    <td><?php echo date('d-m-Y', strtotime($data["tgl_diklat"]));   ?></td>
