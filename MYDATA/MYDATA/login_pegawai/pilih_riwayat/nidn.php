...
<body id="page-top">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_nidn.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
       <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
           <?php
                ...
                $data_nidn = mysqli_query($koneksi,"select * from nidn where nip_nup='$nipnup'");
...
-->
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_nidn.php?id_nidn=<?php echo $data['id_nidn']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
