...
<body id="page-top">
  ...
  <div class="card-body">
    <nav class="navbar navbar-expand navbar-light bg-light mb-4">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>Silahkan Pilih : &nbsp;Mutasi</b>  </a>
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_sk_m.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_sk_m.php?id_sk=<?php echo $data['id_sk']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
