...
<body id="page-top">
  ...
  <div class="card-body">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="sk_kenaikan_pangkat.php">SK Kenaikan Pangkat</a>
    ...
    <div class="table-responsive">
        <a href="../riwayat/tambah_riwayat_jaf.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-danger btn-sm" href="../riwayat/aksi_hapus_riwayat_jaf.php?id_riwayat_jabatan_AF=<?php echo $data['id_riwayat_jabatan_AF']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
                    <td><?php echo date('d-m-Y', strtotime($data["tmt_jabatan"]));   ?></td>
