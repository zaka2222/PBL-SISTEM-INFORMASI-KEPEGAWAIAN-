...
-->
            ...
            <tbody>
               <?php
                    ...
                    $data_sk = mysqli_query($koneksi,"select * from data_sk where nip_nup='$nipnup'");
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <?php
                                    ...
                                    <?php if ($cek >=1): ?>
                                    <a href="../pilih_riwayat/view_sk.php?file_sk=<?php echo $data['file_sk']; ?>">
                                        <label style="color: blue;"><?php echo $data['file_sk']; ?></label><p>
                                    </a>

                                     <?php elseif ($cek2>=1): ?>
                                    <a href="#muncul3<?php echo $data['id_sk']; ?>" data-toggle="modal">
                                         <img src="../riwayat/file_sk/<?php echo $data['file_sk']; ?>" class="img-fluid shadow" style="width: 180px;"></p>
                                    </a>
                            ...
                            <form method="post" action="aksi_upload_sk.php" enctype="multipart/form-data">
                                ...
                                <input type="hidden" class="form-control" name="id_sk" value="<?php echo $data['id_sk']; ?>" required>
                                ...
                                <input type="hidden" class="form-control" name="jenis_sk" value="<?php echo $data['jenis_sk']; ?>" required>
    ...
    <div class="modal fade" id="muncul3<?php echo $data['id_sk'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <img src="../riwayat/file_sk/<?php echo $data['file_sk']; ?>" class="img-fluid shadow" style="width: 500px;">
