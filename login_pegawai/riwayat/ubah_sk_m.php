            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-12">
                       <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Dashboard / Ubah SK Capeg/Tetap</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                              $sk_m=$koneksi->query("SELECT * FROM data_sk WHERE id_sk='$_GET[id_sk]'");
                              $data=mysqli_fetch_assoc($sk_m);
                            ?>
                 
                            <div class="card shadow mb-4 border-bottom-primary">
                                <div class="card-body">

 <form method="POST" action="aksi_ubah_sk_m.php?id_sk=<?php echo $data['id_sk']; ?>" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="../pilih_riwayat/sk_mutasi.php" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
        </div>
    </form>                                    
