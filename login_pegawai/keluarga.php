...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4 border-bottom-primary">
                                <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a class="nav-link  active" href="keluarga.php"><b>Keluarga</b></a></li>
  ...
  <div class="card-body">
    <div class="table-responsive">
        <a href="keluarga/tambah_keluarga.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data</a>
        <p>
            ...
            ?> 
                <tr>
                    ...
                    <td class="actions" style="text-align:center;">
                        ...
                        <a class="btn btn-primary btn-sm" href="keluarga/detail_kel.php?id_keluarga=<?php echo $data['id_keluarga']; ?>" title="Detail"><i class="fas fa-fw fa-eye"></i></a>
                        ...
                        <a class="btn btn-danger btn-sm" href="keluarga/aksi_hapus_kel.php?id_keluarga=<?php echo $data['id_keluarga']; ?>" title="Hapus" onclick="return confirm('Yakin Ingin Mengapus Data ini ?')"><i class="fas fa-trash"></i></a>
                    </td>
